  ...
  return (
    <div className="h-screen bg-gray-50 flex">
      ...
      <aside className="hidden md:flex md:flex-col w-56 bg-gradient-to-b from-primary-900 to-black text-white">
        ...
        <div className="border-t border-primary-800 flex flex-col w-full py-2">
          <div className="flex p-4 items-center gap-3 mb-3 px-2">
          ...
          <button onClick={logout}
            className="w-full px-4 py-2.5 text-sm text-primary-300 hover:text-white hover:bg-white/10 transition-all text-left flex items-center gap-2">
            <LogoutIcon />
            Cerrar Sesion
          </button>
        </div>
      ...
      <div className="flex-1 flex flex-col">
        <header className="md:hidden bg-primary-600 text-white px-4 py-3 flex items-center shadow-md justify-between sticky top-0 z-30">
